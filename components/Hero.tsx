        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <div className="mt-10 flex items-center gap-6 justify-center md:justify-start text-slate-500">
              <a href="https://github.com/Mahesh8806" target="_blank" rel="noreferrer" className="hover:text-cyan-400 transition-colors"><Github className="w-6 h-6" /></a>
          ...
          >
             ...
             <div className="relative w-72 h-72 md:w-[500px] md:h-[500px]">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-slate-900/80 backdrop-blur-xl border border-slate-700 p-4 md:p-6 rounded-2xl shadow-2xl w-[90%] md:w-3/4 max-w-sm overflow-hidden">
                   ...
                   <div className="space-y-1.5 md:space-y-2 font-mono text-[10px] sm:text-xs md:text-sm text-slate-300 overflow-x-auto">
                     ...
                     <p>)</p>
                     <div className="mt-3 md:mt-4 p-2 bg-slate-950 rounded border-l-2 border-cyan-500">
